...
public class EcommerceApplication {
    ...
    CommandLineRunner runner(ProductService productService) {
        return args -> {
            ...
            productService.save(new Product(7L, "Watch", 30.00, "https://images-na.ssl-images-amazon.com/images/I/81%2Bd6eSA0eL._UY445_.jpg"));
            productService.save(new Product(8L, "Shoes", 90.00, "http://placehold.it/200x100"));
            productService.save(new Product(9L, "Knife", 30.00, "http://placehold.it/200x100"));
            productService.save(new Product(10L, "Blanket", 5.00, "http://placehold.it/200x100"));
